...
<h2>Dashboard</h2>
<p>
    We from the Skamps-Team have coded this advanced License-System and the Webpanel with a pation to high usability and
    ...
    Please make sure that you rate this resource 5/5 Stats on <a
        href="https://www.spigotmc.org/resources/advancedlicense.20823/" style="color:#006ee0;">Spigot</a> if you like
    our work.<br/>
...
<?php if (STATS) { ?>
    ...
    <div
        style="background-color: rgba(104, 255, 101, 1); width:20px; height:20px; border-radius:5px; float: left;"></div>
